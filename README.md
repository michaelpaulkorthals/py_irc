...
As an expierienced DIY home automation expert, you are capable to build this device easiy and to have fun on a rainy weekend.
...
Study the schematic diagrams and datasheets of my infrared remote control in the [irc_circuit folder](https://github.com/michaelpaulkorthals/py_irc/irc_circuit).
